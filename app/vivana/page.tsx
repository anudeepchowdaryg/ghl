...
export default function VivanaProject() {
  ...
  return (
    <main style={{ backgroundColor: '#fff', color: '#111', minHeight: '100vh', fontFamily: 'var(--font-instrument-sans)', overflowX: 'hidden' }}>
      ...
      <ProjectHero
        imageSrc="/vivana.jpeg"
        imageAlt="Vivana"
        scrollY={scrollY}
        subtitle="Residences"
        titleWords={['VIVANA']}
        badgeLines={['LAT: 13.0232° N', 'ELEV: 924M', 'STATUS: COMMISSIONED']}
      />
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8rem', justifyContent: 'center' }}>
          <Reveal direction="left" style={{ flex: '1 1 400px', maxWidth: '600px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: 800, margin: 0, letterSpacing: '-0.03em', lineHeight: 1.1, color: '#111' }}>
              Where modern lines meet <span style={{ color: '#888', fontWeight: 800 }}>metropolitan spatial flow.</span>
            </h2>
          </Reveal>
          <Reveal direction="right" delay={150} style={{ flex: '1 1 400px', maxWidth: '600px', paddingTop: '4rem' }}>
            <p style={{ fontSize: '1.45rem', lineHeight: 1.8, color: '#222', marginBottom: '2.5rem', fontWeight: 400 }}>
              Vivana introduces 10 premium 3 BHK flat sanctuaries located in Bangalore's iconic HRBR Layout. Explicitly crafted for spatial efficiency, natural acoustics, and luminous internal core geometries.
            </p>
            <p style={{ fontSize: '1.45rem', lineHeight: 1.8, color: '#666', fontWeight: 400 }}>
              A standard-setting luxury residential retreat meticulously detailed and curated under GHL's uncompromising construction principles.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section style={{ width: '100vw', height: '85vh', position: 'relative', padding: '0 clamp(2rem, 5vw, 5rem)' }}>
         <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden', boxShadow: '0 30px 60px rgba(0,0,0,0.05)' }}>
            <Image src="/vivana.jpeg" alt="Interior Detail" fill sizes="(max-width: 1200px) 100vw, 85vw" style={{ objectFit: 'cover' }} />
         </div>
      </section>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Reveal direction="left" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Somany Ceramics</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>Flawless vitrified slab flooring flowing seamlessly from master pavilions into private balconies.</p>
            </Reveal>
            {/* Item 2 */}
            <Reveal direction="right" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Bespoke Windows</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>6-Feet tall architectural timber-framed UPVC panels securing quiet, insulated internal envelopes.</p>
            </Reveal>
            {/* Item 3 */}
            <Reveal direction="left" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Grohe concealed</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>Master bathrooms pre-fitted with elite architectural sanitaryware and smart valves.</p>
            </Reveal>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2.5rem' }}>
            ...
            <Reveal direction="left" className="gallery-item" style={{ gridColumn: 'span 8', position: 'relative', height: '550px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              ...
              <Image src="/vivana.jpeg" alt="Vivana Architectural View" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 70vw, 60vw" style={{ objectFit: 'cover' }} />
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                <span style={{ fontSize: '0.75rem', letterSpacing: '2px', textTransform: 'uppercase', opacity: 0.8, fontWeight: 700 }}>Exterior Elevation</span>
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Modern Facade</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="right" delay={120} className="gallery-item" style={{ gridColumn: 'span 4', position: 'relative', height: '550px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              <div className="gallery-overlay" />
              <Image src="/vision.png" alt="Vivana Interior" fill sizes="(max-width: 768px) 100vw, 30vw" style={{ objectFit: 'cover' }} />
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                <span style={{ fontSize: '0.75rem', letterSpacing: '2px', textTransform: 'uppercase', opacity: 0.8, fontWeight: 700 }}>Interior Pavilion</span>
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Sleek Living</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="left" delay={200} className="gallery-item" style={{ gridColumn: 'span 4', position: 'relative', height: '420px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              <div className="gallery-overlay" />
              <Image src="/Residential_&_Apartment_Projects.jpeg" alt="Vivana Detail" fill sizes="(max-width: 768px) 100vw, 30vw" style={{ objectFit: 'cover' }} />
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                <span style={{ fontSize: '0.75rem', letterSpacing: '2px', textTransform: 'uppercase', opacity: 0.8, fontWeight: 700 }}>Residential Element</span>
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Engineering</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="right" delay={280} className="gallery-item" style={{ gridColumn: 'span 8', position: 'relative', height: '420px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              <div className="gallery-overlay" />
              <Image src="/Site_preparation_infrastructure.jpeg" alt="Vivana Infrastructure" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 70vw, 60vw" style={{ objectFit: 'cover' }} />
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                <span style={{ fontSize: '0.75rem', letterSpacing: '2px', textTransform: 'uppercase', opacity: 0.8, fontWeight: 700 }}>Structure</span>
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Solid Foundations</h4>
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <section style={{ padding: '15rem clamp(2rem, 8vw, 10rem)', backgroundColor: '#111', color: '#fff' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '6rem' }}>
          ...
          <Reveal direction="left" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p style={{ fontSize: '1.25rem', color: '#aaa', lineHeight: 1.8, fontWeight: 400, marginBottom: '3rem' }}>
                Enjoying absolute connectivity inside Bangalore's sought-after HRBR Layout neighborhood core.
              </p>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
              <div className="loc-card" style={{ padding: '2.5rem 1.5rem', borderRadius: '12px', display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#161616' }}>
                <p style={{ fontSize: '3rem', fontWeight: 800, margin: '0 0 0.5rem 0', lineHeight: 1, letterSpacing: '-1px', color: '#fff' }}>10 <span style={{ fontSize: '1.1rem', color: '#666', fontWeight: 700, letterSpacing: '0' }}>mins</span></p>
                <p style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '2px', color: '#aaa', margin: 0, fontWeight: 700 }}>To Outer Ring Road</p>
              </div>
              <div className="loc-card" style={{ padding: '2.5rem 1.5rem', borderRadius: '12px', display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#161616' }}>
                <p style={{ fontSize: '3rem', fontWeight: 800, margin: '0 0 0.5rem 0', lineHeight: 1, letterSpacing: '-1px', color: '#fff' }}>25 <span style={{ fontSize: '1.1rem', color: '#666', fontWeight: 700, letterSpacing: '0' }}>mins</span></p>
                <p style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '2px', color: '#aaa', margin: 0, fontWeight: 700 }}>To Central Business Dist</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="right" delay={150} style={{ position: 'relative', width: '100%', height: '480px', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.05)', boxShadow: '0 30px 60px rgba(0,0,0,0.4)' }}>
            <iframe 
              src="https://maps.google.com/maps?q=HRBR%20Layout%20Bangalore&t=&z=14&ie=UTF8&iwloc=&output=embed" 
              width="100%" 
              height="100%" 
      ...
      <section className="brochure-container" style={{ display: 'flex', flexWrap: 'wrap', backgroundColor: '#fff', borderTop: '1px solid #eaeaea' }}>
        <Reveal direction="left" style={{ flex: '1 1 500px', position: 'relative', minHeight: '65vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5f7f8', perspective: '1200px', overflow: 'hidden' }}>
          ...
          <div className="brochure-mockup" style={{
            ...
            <h3 style={{ fontSize: '2.8rem', fontWeight: 800, color: '#111', margin: 0, letterSpacing: '-0.04em', textAlign: 'center', zIndex: 2, lineHeight: 1.1 }}>VIVANA</h3>
