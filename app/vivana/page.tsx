          ...
          <div className="project-gallery-grid">
            ...
            <Reveal direction="left" className="gallery-item gallery-item--wide">
              ...
              <div className="gallery-caption">
                ...
                <h4 className="gallery-caption__title">Modern Facade</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="right" delay={120} className="gallery-item gallery-item--narrow-tall">
              ...
              <div className="gallery-caption">
                <span className="gallery-caption__eyebrow">Interior Pavilion</span>
                <h4 className="gallery-caption__title">Sleek Living</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="left" delay={200} className="gallery-item gallery-item--narrow">
              ...
              <div className="gallery-caption">
                <span className="gallery-caption__eyebrow">Residential Element</span>
                <h4 className="gallery-caption__title">Engineering</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="right" delay={280} className="gallery-item gallery-item--wide-short">
              ...
              <div className="gallery-caption">
                ...
                <h4 className="gallery-caption__title">Solid Foundations</h4>
              </div>
            </Reveal>
          </div>
        </div>
