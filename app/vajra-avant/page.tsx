  ...
  return (
    <main style={{ backgroundColor: '#fff', color: '#111', minHeight: '100vh', fontFamily: 'var(--font-instrument-sans)', overflowX: 'hidden' }}>
      ...
      <ProjectHero
        ...
        badgeLines={['LAT: 17.4622° N', 'ELEV: 539M', 'STATUS: COMMISSIONED']}
      />
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8rem', justifyContent: 'center' }}>
          <Reveal direction="left" style={{ flex: '1 1 400px', maxWidth: '600px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: 800, margin: 0, letterSpacing: '-0.03em', lineHeight: 1.1, color: '#111' }}>
              Where bespoke luxury meets <span style={{ color: '#888', fontWeight: 800 }}>architectural symmetry.</span>
            </h2>
          </Reveal>
          <Reveal direction="right" delay={150} style={{ flex: '1 1 400px', maxWidth: '600px', paddingTop: '4rem' }}>
            <p style={{ fontSize: '1.45rem', lineHeight: 1.8, color: '#222', marginBottom: '2.5rem', fontWeight: 400 }}>
              Vajra Avant delivers 5 exclusive luxury residences crafted in Hyderabad's coveted Kondapur district. Intricately planned to offer seamless indoor-outdoor connections, pin-drop quiet interiors, and a monumental street-front posture.
            </p>
            <p style={{ fontSize: '1.45rem', lineHeight: 1.8, color: '#666', fontWeight: 400 }}>
              An signature address designed to stand as an enduring icon of modern residential design and concrete perfection.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Reveal direction="left" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Monolithic Frame</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>Heavy-duty M25 and TMT 550D structural core shielding spaces from environmental shifts.</p>
            </Reveal>
            {/* Item 2 */}
            <Reveal direction="right" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Premium Somany</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>Expansive double-charged vitrified flooring bringing reflective luminance to every master suite.</p>
            </Reveal>
            {/* Item 3 */}
            <Reveal direction="left" className="craft-item" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '3.5rem 0', flexWrap: 'wrap', gap: '2rem', transition: 'all 0.5s ease', width: '100%' }}>
              <h4 style={{ fontSize: '2.6rem', fontWeight: 800, margin: 0, color: '#111', letterSpacing: '-0.02em' }}>Teak Openings</h4>
              <p style={{ fontSize: '1.25rem', color: '#555', maxWidth: '450px', margin: 0, fontWeight: 400, lineHeight: 1.7 }}>8-Feet high solid teakwood frames with premium hand-polished wooden door shutters.</p>
            </Reveal>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2.5rem' }}>
            ...
            <Reveal direction="left" className="gallery-item" style={{ gridColumn: 'span 8', position: 'relative', height: '550px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                ...
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Grand Posture</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="right" delay={120} className="gallery-item" style={{ gridColumn: 'span 4', position: 'relative', height: '550px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                ...
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>High-End Living</h4>
              </div>
            </Reveal>
            ...
            <Reveal direction="left" delay={200} className="gallery-item" style={{ gridColumn: 'span 4', position: 'relative', height: '420px', overflow: 'hidden', borderRadius: '12px', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ position: 'absolute', bottom: '2.5rem', left: '2.5rem', color: '#fff', zIndex: 2 }}>
                <span style={{ fontSize: '0.75rem', letterSpacing: '2px', textTransform: 'uppercase', opacity: 0.8, fontWeight: 700 }}>Interior Detail</span>
                <h4 style={{ fontSize: '2rem', fontWeight: 800, margin: '0.3rem 0 0 0', letterSpacing: '-0.02em' }}>Modern Finishes</h4>
              </div>
            </Reveal>
      ...
      <section className="brochure-container" style={{ display: 'flex', flexWrap: 'wrap', backgroundColor: '#fff', borderTop: '1px solid #eaeaea' }}>
        <Reveal direction="left" style={{ flex: '1 1 500px', position: 'relative', minHeight: '65vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5f7f8', perspective: '1200px', overflow: 'hidden' }}>
          ...
          <div className="brochure-mockup" style={{
            ...
            <h3 style={{ fontSize: '2.8rem', fontWeight: 800, color: '#111', margin: 0, letterSpacing: '-0.04em', textAlign: 'center', zIndex: 2, lineHeight: 1.1 }}>VAJRA<br/>AVANT</h3>
